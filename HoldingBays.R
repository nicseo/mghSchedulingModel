...
HoldingBay = read.csv("/Users/nicseo/Desktop/MIT/Junior/Fall/UROP/Scheduling Optimization/Script/Python Output Data/HB_HBPriority_CathFlatEPGrow2.csv")
...
write.csv(t(HB), "HoldingBayOccupancy2.csv")
